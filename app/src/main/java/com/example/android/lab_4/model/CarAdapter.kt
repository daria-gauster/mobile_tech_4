package com.example.android.lab_4.model
...
import com.example.android.lab_4.R
...
class CarAdapter : RecyclerView.Adapter<CarAdapter.CarViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CarViewHolder {
        return CarViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_car,
        parent, false))
    }
